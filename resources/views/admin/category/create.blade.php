...
<form id="product_creat" action="{{ URL::to('/dashboard/category/store') }}" method="POST">
    @csrf
    <div class="form-group">
      <label>Tên danh mục</label>
      <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" onkeyup="ChangeToSlug();"  placeholder="Enter name">
      @error('name')
  ...
  @enderror
    ...
    <div class="form-group">
    <label>Từ khóa</label>
    <input type="text" class="form-control @error('keywords') is-invalid @enderror" name="keywords" value="" data-role="tagsinput" >
    @error('keywords')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
</div>
<div class="form-group">
    ...
    <select class="form-control" name="category_parent">
        ...
        <option value="{{$val->id}}"><strong>{{ $val->name }}</strong></option>
